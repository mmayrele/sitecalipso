                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="" class="navbar-brand">
                            <h1 class="m-0 text-white"></i>Calipso Dynamics</h1>
                        </a>
                        <p class="mt-3 mb-4">Mantengase al tanto de todas las novedades y ofertas, Calipso Dynamics es la herramienta perfecta para que su empresa de el paso al siguiente nivel</p>
                        <form action="">
                            <div class="input-group">
                                <input type="text" class="form-control border-white p-3" placeholder="Su correo">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            <div class="section-title-1 section-title-sm position-relative pb-3 mb-4">
                                <h3 class="text-light mb-0">Contáctenos</h3>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-geo-alt text-primary me-2"></i>
                                <p class="mb-0">Santo Domingo, Republica Dominicana</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">info@calipsodynamics.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+1(829)451-0641</p>
                            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">2024 &copy; Calipso Dynamics. Todos los derechos reservados</p>
                    </div>
                </div>
            </div>
        </div>
